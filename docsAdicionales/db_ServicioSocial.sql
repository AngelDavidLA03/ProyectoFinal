...
CREATE TABLE Realizar (
	...
	estado VARCHAR(10) NULL COMMENT 'Solo permitir valores como ACEPTADO, RECHAZADO o FINALIZADO'
) ENGINE=INNODB;
...
VALUES (idDocument,curp,idDirector);
...
VALUES (idDocument,rfc,idDirector);
...
CONTAINS SQL
SQL SECURITY DEFINER
COMMENT 'PROCEDIMIENTO PARA LA CLASIFICACION DE DOCUMENTOS - NUMERO DE SEGURO SOCIAL'
